...
out_files = [
    r"MMEM:STOR:TRAC 'Trc1','c:\users\instrument\desktop\res\uv3u\20.csv',FORM,LOGP,COMM",
    r"MMEM:STOR:TRAC 'Trc1','c:\users\instrument\desktop\res\uv3u\21.csv',FORM,LOGP,COMM",
    r"MMEM:STOR:TRAC 'Trc1','c:\users\instrument\desktop\res\uv3u\22.csv',FORM,LOGP,COMM",
    r"MMEM:STOR:TRAC 'Trc1','c:\users\instrument\desktop\res\uv3u\23.csv',FORM,LOGP,COMM",
]
...
def measure_20_23():
    ...
    src.write(f'APPLY {volt}V,{amp + 5}ma,1')
